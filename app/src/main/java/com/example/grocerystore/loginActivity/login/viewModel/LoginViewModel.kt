package com.example.grocerystore.loginActivity.login.viewModel
...
class LoginViewModel(private val repository: UserRepoInterface) : ViewModel() {
    ...
    fun login(email: String, password: String) : Boolean{
        ...
        viewModelScope.launch {
            try {
                ...
                val user = (userNotClear as Result.Success<UserUIState?>).data
