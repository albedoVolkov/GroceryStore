...
class StoreFragmentViewModel(private val dishesRepository: DishesRepoInterface,private val categoriesRepository : CategoriesRepoInterface,sessionManager : ShoppingAppSessionManager) : ViewModel() {
